...
Before we move on, I must address a notion that the use of Hebrew/Aramaic is a sign of higher literary quality. Thus, the Big Three and other greats presumably use more than ordinary people. This was put to rest by Ph.D. Mechanical Engineer David Chassin ("my stepson the doctor") and me.  We did a careful count of several great works --one of which was "Tevye"-- as well as typical spoken language and showed that just the oppsite was true.  Not only does the use of Hebrew/Aramaic not correlate with accepted greatness, but ordinary Yiddish spoken by "the masses" contained more Hebrew/Aramaic than any of the literary works we considered.
