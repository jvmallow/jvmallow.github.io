...
In 1980, Professor of Psychology Richard Bowen (my Loyola colleague) and his coworkers descovered that if you shine a pulsed bright light over a brief time into the eye and follow it with another, you (or someone else you have talked into looking)  sees the second one flickering once or twice, despite the fact that the light iself doesn't. From this we concluded that the flickering is generated in the eye itself. Rich asked me if physics could help in understanding the phenomenon. You might have seen oscillating pulses on a cardiac machine in a hospital. They are the flicker response to a pulse from the heart. You might also have see a square pulse analogous in shape to our inital bright light--hopefully not: that's called flatlining, and you know what it means.  

Back to our subject.  Since the bright square-shaped "inducing" pulse causes flicker of th "responce pulse", suppose we make the inducer flicker and see what the response does. I proposed that we try a non-square inducing pulse and see what happens to the to the flicker. Are there inducer frequencies that produce brighter and/or more flickers? There is a physical effect called resonance, which occures in many phenomena. So we tried, and it did. (The observers were Rich, one of his students and your truly.) At certain frequncies of the inducer, we saw the  flicker intensity light wbecome higher and in general more flickers saw flickers at more than one inducer frequency. This was more complicted that the renonace effect for a playground swing where puchng it at only one frequency gives the highest reponse (in both sense of the word). Let's turn to a musical instrument for anothr analogy. For any but the flute, whihc roduces a single resonance there appear ultraharmonics: overtones. Its name gives the information: in addition to the fundamental,  higher frequencies appear: those tell you what the instrument is.But there are also lower frequencies appearing: so-called subharmonics or undertones (really--that's the word). Here is an example. https://www.youtube.com/watch?v=i5CSUHpK4QM&t=147). And over-and undertones of flickers were what we saw. Altogether, we saw three resonances: the "fundamental", one overtone and one undertone.  But if you drove the inducee harder; i.e., increased the intensity of its light, The fundamental appeared at a different frecuency than predicted by the simplest physics then the overtone (ultraharmonic) appeared three times that frequency, and the undertone (subharmonic) at 1/3  of it. 

Why? The biology we don't know: that's not our expertise. But the physics we do. Perhaps someday it will be explained by the biology.
