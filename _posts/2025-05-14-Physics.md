...
The next element is helium, which in its simplest forrm is a nucleus four time as heavy and twice as charged as hydrogen's, with two electrons circling it, as in Figure___. (Two important properties of helium. First, it is used in balloons, because is is lighter than air and thus floats. Second, if you breathe it in, you can sound like Donald Duck.) 
