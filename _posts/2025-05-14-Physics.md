...
The next element is helium, which in its simplest forrm is a nucleus four times as heavy and twice as charged as hydrogen's, with two electrons circling it, as in Figure&nbsp;4. (Two important properties of helium. First, it is used in balloons, because it is lighter than air and thus floats. Second, if you breathe it, you can sound like Donald Duck.) 
