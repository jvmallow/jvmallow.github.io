...
Ordinary Stars are generally mostly hydrogen. So we might expect to see spectral lines due to the size of the drop of an electron from one energy level to a lower one. Astrophycists have determined what the intrinsic brighness of each of the stars would be. You would think that these values would tell you how far away the star is. Not quite. In addition to the size of the energy jump, there is a probability of its likeliness of making that jump that has to be factored in. We call that the "transitional probability". That's what we can calculate using self-consistent field theory, and that was the subject of my Ph.D. dissertation. I did it for carbon, notrogen, and oxygen. Why? Because astrohysicists have found some in stars, albeit in much lower quantity that hydrogen. So there it stood. But now came another problem: the wavelngthsof their spectra were mostly at wavelngths the ultraviolet
range. (Think sunburn.) The Earth's atmosphere block most of that out. The only way to us my results would be in measurement made from outside the Earth's atmosphere. So the sta my results in obscure journals, from 1971--until the early 1990's, when a colleague came to me, excitedly announcing that my results were now being. In a word (well, two words): Hubble Telescope! Not exactly the text on my T-shirt; "I became a physicist for the fame and the money,  bu gratifying nonetheless to have made a contribution to knowledge about the stars.
