...
One method that has proved particularly effective is group project work. Group methods have been shown to be pedagogically effective. One of the greatest virtues of group work is that it levels the playing field, especially for females and less confident students.  [Here is an article I wrote about it](https://link.springer.com/article/10.1023/A:1009468912400), describing grouo work in Denmark, where it has a long history, and the ways it can be adapted for the US. The link is to the (very brief) abstract. I can send you a hard copy if you are interested.
...
<img src="https://github.com/jvmallow/jvmallow.github.io/blob/main/images/fear_of_physics.jpg?raw=true" style="float:right;width=100" />
...
Much more can be said about pedagogy, but this shall suffice. You can find more in Helge Kastrup's and my book : *Fear of Physics*  [https://iopscience.iop.org/book/mono/978-0-7503-4866-9](https://iopscience.iop.org/book/mono/978-0-7503-4866-9)
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Lindheimer_Observatory_Northwestern_Univ_40.jpg/500px-Lindheimer_Observatory_Northwestern_Univ_40.jpg" style="float:right;width:300;margin:10" /> 
...
![Figure 4](https://raw.githubusercontent.com/jvmallow/jvmallow.github.io/adc8a1c536172ff17dd867f8aa43e821de6c8322/images/helium_atom_structure.svg)
...
We found that there are a dozen such systems. One is the hydrogen atom. Another works for diatomic (two-atom) molecules. A third is the quantum version of the harmonic oscillator. (The macroscopic version is a vertical pendulum as in a grandfather clock, or a mass oscillating on a spring, as in Figure_&nbsp;7.) The others are for more arcane systems. 

<img src="https://github.com/jvmallow/jvmallow.github.io/blob/main/images/mass_spring.gif?raw=true" /><img src="https://github.com/jvmallow/jvmallow.github.io/blob/main/images/pendulum.gif?raw=true" />
<br/>Figure 7 - Harmonic oscillator model of mass spring
...
“Elastic Backscattering Measurements of Fog over Lake and Land,” J.V. Mallow, M.H. Horowitz, G.D. Stein, M.B. Lewis and A.J. Freeman, Proc. Fifth Conference on Laser Radar Studies of the Atmosphere (1973). [URL](https://scholar.google.com/scholar?q=Proc.+Fifth+Conference+on+Laser+Radar+Studies+of+the+Atmosphere+(1973).&hl=en&as_sdt=0&as_vis=1&oi=scholart)
