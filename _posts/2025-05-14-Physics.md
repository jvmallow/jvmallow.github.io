...
Over the next few years, Bohr's model was modified; for example, the orbits wereshown to be elliptical rather than cicular. But then came a model of the atom that overthrew Bohr's, relegating it to the ibriquet "The old quantum mechanics". The new quantum mechancs, whihc we have to this day is based on the premise that an electron (and any other particle) is also a wave. The breakthrough was provied by Erwin Schrodinger (he of the cat), withnhis famous equation inking wave and particle properties. To give two concrete examples, if you look through a screen door at a streelight, it will appear to have alternating light and dark sections; This is proof of th wave nature of light. On the other hand,when an elevator door reopens as you leap in, that's because you are interrupting an invisible beam of light, which triggers a crcuit whhich reopens the door. That beam can only be explained by light being made up of particles.

So far, so good. But now things get a little more complicated (and this is where my own work come in). Lets stick with the Bohr modelfor conveneience. Hydrogen in its simplest form consists of two particles: a heavy, positively charged nucleus and a light, negatively chanrged electron crcling it, ans in the figure above. The next element up is helium, which in its simlest forrm is a nucleus twice as heavy  and twice as charged as hydrogen's, and two electrons circling it. A tangential word about two important properties of helium. First, it is used in balloons, because is is lighter than air and thus floats. Second, if you breathe it, you can sound like Donald Duck. 

Here's the problem: the structure of the hydrogen gas can be obtained by exact calcuation. The spectrum of helium, and all the other elements can only be obtaind approximately. This has nothng to do with quantum physics. I turns out, and has been proved mathematically centuries ago, hat the two-body problem is the only one that can be solved exactly. And hydrogen gas is the only case of this. So physicists have consturcted elaborate schemes to get good approximate results; i.e. those that match experiment,in our case, spectra.
